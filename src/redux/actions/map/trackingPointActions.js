import {
  ADD_TRACKING_POINT, ADD_TRACKING_POINT_ON_MAP,
  ADD_TRACKING_POINT_ON_MAP_FAILED,
  ADD_TRACKING_POINT_ON_MAP_SUCCESS,
  DELETE_ALL_TRACKING_POINT_ON_MAP, DELETE_ONE_TRACKING_POINT_ON_MAP, FETCH_ALL_TRACKING_POINT_ON_MAP,
  FETCH_ALL_TRACKING_POINT_ON_MAP_FAILED,
  FETCH_ALL_TRACKING_POINT_ON_MAP_SUCCESS, SET_SELECTED_TRACKING_POINT, SET_TRACKING_POINTS_ON_MAP, UPDATE_CAMERA_ON_MAP_BY_TRACKING_POINT, UPDATE_CAMERA_ON_MAP_BY_TRACKING_POINT_FAILED, UPDATE_CAMERA_ON_MAP_BY_TRACKING_POINT_SUCCESS, UPDATE_CURRENT_LANG, UPDATE_TRACKING_POINT
} from "../../types/map";
