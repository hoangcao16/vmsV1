...
const cameraApi = {
    ...
    async get(uuid) {
        const response = await new Promise((resolve, reject) => {
            controllerApi.axiosIns.get(`${CAMERA_ENDPOINT}/${uuid}`)
    ...
    async createNew(cam) {
        const response = await new Promise((resolve, reject) => {
            controllerApi.axiosIns.post(CAMERA_ENDPOINT, cam)
                .then(response => resolve(response))
                .catch(error => reject(error))
        })
        if (response && response.data) {
    ...
    async delete(uuid) {
        const response = await new Promise((resolve, reject) => {
            controllerApi.axiosIns.delete(`${CAMERA_ENDPOINT}/${uuid}`)
                .then(response => resolve(response))
                .catch(error => reject(error))
        })
        if (response && response.data) {
    ...
    async getCamsByTrackingPoint(bodyJson) {
        const response = await new Promise((resolve, reject) => {
            controllerApi.axiosIns.post(CAMERA_BY_TRACKING_POINT, bodyJson)
                .then(response => resolve(
                    response
                ))
                .catch(error => reject(error))
