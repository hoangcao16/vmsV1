...
const ptzControllerApi = {
  ...
  async getPreset(queryParams) {
    const response = await new Promise((resolve, reject) => {
      try {
        controllerApi.axiosIns
          .get(`${PTZCONTROLLER_ENDPOINT}/search-preset`, {
            params: queryParams,
          })
          .then((response) => resolve(response))
          .catch((error) => reject(error));
  ...
  async getPresetTour(queryParams) {
    const response = await new Promise((resolve, reject) => {
      try {
        controllerApi.axiosIns
          .get(`${PTZCONTROLLER_ENDPOINT}/search-preset-tour`, {
            params: queryParams,
          })
          .then((response) => resolve(response))
          .catch((error) => reject(error));
