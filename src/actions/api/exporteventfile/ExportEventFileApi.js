...
const ExportEventFileApi = {
    ...
    getEventFileList: async (params) => {
        const response = await new Promise((resolve, reject) => {
            controllerApi.axiosIns.get(EVENT_FILE_ENDPOINT, {
                params: params,
            })
                .then(response => resolve(response))
                .catch(error => reject(error))
    ...
    getImportantFileList: async (params) => {
        const response = await new Promise((resolve, reject) => {
            controllerApi.axiosIns.get(IMPORTANT_FILE_ENDPOINT, {
                params: params,
            })
                .then(response => resolve(response))
                .catch(error => reject(error))
    ...
    createNewEventFile: async (record) => {
        const response = await new Promise((resolve, reject) => {
            controllerApi.axiosIns.post(EVENT_FILE_ENDPOINT, record)
                .then(response => resolve(response))
                .catch(error => reject(error))
        })
        if (response && response.data) {
    ...
    updateEventFile: async (record, uuid) => {
        const response = await new Promise((resolve, reject) => {
            controllerApi.axiosIns.put(`${EVENT_FILE_ENDPOINT}/${uuid}`, record)
                .then(response => resolve(response))
                .catch(error => reject(error))
        })
        if (response && response.data) {
    ...
    updateFile: async (record, uuid) => {
        const response = await new Promise((resolve, reject) => {
            controllerApi.axiosIns.put(`${FILE_ENDPOINT}/${uuid}`, record)
                .then(response => resolve(response))
                .catch(error => reject(error))
        })
        if (response && response.data) {
    ...
    deleteEventFile: async (uuid) => {
        try {
            const response = await new Promise((resolve, reject) => {
                controllerApi.axiosIns.delete(`${EVENT_FILE_ENDPOINT}/${uuid}`)
                    .then(response => resolve(response))
                    .catch(error => reject(error))
            })
            if (response && response.data) {
