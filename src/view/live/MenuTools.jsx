        ...
        <div>
            <div className="row toolbar py-1">
                <div className="toolbar__grid-selection toolbar__selected-mode">
                    <a className="" size="small" onClick={() => { updateGridSize2(1); setGridSize(1) }}>
                        {
                            gridSize === 1 ?
                                <span className="app-icon mr-1" style={{ backgroundImage: `url(${grid1})` }}></span> :
                                <span className="app-icon icon-grid-1 mr-1"></span>
                        }
                    </a>
                    <a className="" size="small" onClick={() => { updateGridSize2(4); setGridSize(4) }}>
                        {
                            gridSize === 4 ?
                                <span className="app-icon mr-1" style={{ backgroundImage: `url(${grid2})` }}></span> :
                                <span className="app-icon icon-grid-4 mr-1"></span>
                        }
                    </a>
                    <a className="" size="small" onClick={() => { updateGridSize2(9); setGridSize(9) }}>
                        {
                            gridSize === 9 ?
                                <span className="app-icon mr-1" style={{ backgroundImage: `url(${grid3})` }}></span> :
                                <span className="app-icon icon-grid-9 mr-1"></span>
                        }
                    </a>
                    <a className="" size="small" onClick={() => { updateGridSize2(16); setGridSize(16) }}>
                        {
                            gridSize === 16 ?
                                <span className="app-icon mr-1" style={{ backgroundImage: `url(${grid4})` }}></span> :
            ...
            {
                !liveMode &&
                <PlaybackSliderTime playbackByDragSlideTime={playbackByDragSlideTime} dateTimeSeek={dateTimeSeek} />
            }
        </div >
    );
};
