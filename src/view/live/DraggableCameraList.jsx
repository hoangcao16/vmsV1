    ...
    return (
        ...
        >
            ...
            <div className="camera-list__header">
                <a className="toggle-collapse" onClick={toggleCollapsedCameraList} />
                <h5><i className="app-icon icon-camera-list" />{t('view.camera.camera_list', { cam: t('camera') })}</h5>
            </div>
            <Search searchValue={search} onPressEnter={onPressEnter} toggleOpenFilter={toggleOpennedCameraFilter} />
                            ...
                            <li key={index}>
                                ...
                                >
                                    {(provided, snapshot) => (
                                        ...
                                        >
                                            <MapCamItem isControlCam={false} camera={camera} handleSelectCamera={handleSelectCamera} />
                                        </div>
                                    )}
                                </Draggable>
                            </li>
