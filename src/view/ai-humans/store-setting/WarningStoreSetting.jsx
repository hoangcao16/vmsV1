...
const WarningStoreSetting = (props) => {
  ...
  const handleSubmit = async () => {
    ...
    const payloadConverted = {
      ...
      configWarningDisk: {
        percentUsedOne: payload?.percentUsedOne,
        timeOne: payload?.timeOne,
        isActiveOne: payload?.isActiveOne,
        percentUsedTwo: payload?.percentUsedTwo,
        timeTwo: payload?.timeTwo,
        isActiveTwo: payload?.isActiveTwo
      }
    };
    console.log(payloadConverted);
