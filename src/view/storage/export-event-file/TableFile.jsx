    ...
    const renderSetImportantAction = (row) => {
        return (
            <div className='actionEventFile'>
                {!row.isImportant && (
                    <Tooltip placement="bottomLeft" title={t('view.storage.tick')}><FiBookmark
                        className='icon'
                        onClick={(e) => {
                            e.stopPropagation();
    ...
    const renderSetEventAction = (row) => {
        return (
            <div className='actionEventFileInActive'>
                <Tooltip placement="bottomLeft" title={t('view.storage.set_event')}><Popover
