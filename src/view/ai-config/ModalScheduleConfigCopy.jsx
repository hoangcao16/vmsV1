...
const ModalScheduleConfigCopy = (props) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      let isPost = await AIConfigScheduleApi.copyConfigSchedule(
        cameraUuid,
        payload
      );
      ...
      >
        ...
        >
          ...
          <div className="footer__modal">
            ...
            >
              {t("view.ai_config.cancel")}
            </Button>
            <Button disabled={!(selectedRowKeys.length > 0)} htmlType="submit">
