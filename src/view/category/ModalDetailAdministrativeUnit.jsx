...
const ModalDetailAdministrativeUnit = (props) => {
    const { t } = useTranslation();
    const { setShowModalDetail, showModalDetail, selectedCategoryId } = props;
...
export default ModalDetailAdministrativeUnit;
