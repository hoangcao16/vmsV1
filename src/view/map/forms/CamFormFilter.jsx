...
const CameraFormFilter = (props) => {
    ...
    return (
        <>
            <Form.Item name={["cameraGroupUuid"]} label={t('view.map.camera_group', { cam: `${t('camera')}`})}>
                <Select
            ...
            <Form.Item name={["administrativeUnitUuid"]} label={t('view.map.administrative_unit_uuid')}>
                <Select
                    ...
                    showSearch
                    allowClear
                    options={normalizeOptions("name", "id", adDivisions || [])}
